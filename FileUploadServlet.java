...
///////////////
			//	INSERT INTO `books`(`bookid`, `title`, `author`, `generation`, `pages`, 
			//`edition`, `copyrights`, `publishers`, `path`, `category`) VALUES ('[value-1]','[value-2]','[value-3]','[value-4]','
			//	[value-5]','[value-6]','[value-7]','[value-8]','[value-9]','[value-10]')
				///////////////////
				
       // int id = Integer.parseInt(request.getParameter("id"));
	   //title,author,generation,pages,edition,copyrights,publishers,category
        ...
        try {
            ...
            PreparedStatement pst = con.prepareStatement("INSERT INTO `books`(`title`, `author`, `generation`, `pages`,`edition`, `copyrights`, `publishers`, `path`, `category`, `filename`)  values(?,?,?,?,?,?,?,?,?,?)");
            ////title,author,generation,pages,edition,copyrights,publishers,category
            ...
            pst.setString(7, publishers);
            pst.setString(8, savePath);
            pst.setString(9, category);//dbFileName
